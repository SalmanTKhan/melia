...
namespace Melia.Shared.Network
{
	...
	public static class Op
	{
		...
		public const int CZ_REQUEST_BLACK_MARKET_BID = 0xF1D; // Size: 30
		public const int CZ_REQUEST_BLACK_MARKET_BID_INFO = 0xF1E; // Size: 22
		public const int ZC_NOTICE_FAILURE_IN_BIDDING = 0xF1F; // Size: 14
		public const int ZC_NOTICE_BIDDING_SUCCESS = 0xF20; // Size: 30
		public const int ZC_NOTICE_DUPLICATE_BIDDING = 0xF21; // Size: 22
		public const int ZC_NOTICE_NOTICE_BLACK_MARKET_END_TO_USER = 0xF22; // Size: 22
		public const int ZC_CONFUSE_STATE = 0xF23; // Size: 15
		public const int ZC_ADDONUI_MSG = 0xF24; // Size: 0
		public const int CZ_COLONY_REWARD_REQ = 0xF25; // Size: 51
		public const int ZC_COLONY_REWARD_DETAILLIST_UPDATE = 0xF26; // Size: 22
		public const int ZC_COLONY_SECONDLEAGUE_REWARD_START = 0xF27; // Size: 38
		public const int ZC_COLONY_SECONDLEAGUE_REWARD_END = 0xF28; // Size: 38
		public const int CZ_COLONY_TAXINQUIRELIST_REQ = 0xF29; // Size: 22
		public const int ZC_COLONY_TAXINQUIRELIST_REQ = 0xF2A; // Size: 0
		public const int ZC_START_FIELDBOSS_WORLD_EVENT = 0xF2B; // Size: 0
		public const int ZC_END_FIELDBOSS_WORLD_EVENT = 0xF2C; // Size: 10
		public const int ZC_FIELDBOSS_REMOVE_ITEM = 0xF2D; // Size: 14
		public const int CZ_BID_FIELDBOSS_WORLD_EVENT = 0xF2E; // Size: 26
		public const int ZC_WIN_FIELDBOSS_WORLD_EVENT_ITEM = 0xF2F; // Size: 14
		public const int ZC_LOSE_FIELDBOSS_WORLD_EVENT_ITEM = 0xF30; // Size: 14
		public const int ZC_SILVER_GACHA_DECREASE_ITEM_COUNT = 0xF31; // Size: 26
		public const int CZ_REQUEST_SILVER_GACHA_GAMBLE = 0xF32; // Size: 35
		public const int CZ_REQUEST_SILVER_GACHA_INFO = 0xF33; // Size: 22
		public const int ZC_RESPONSE_SILVER_GACHA_INFO = 0xF34; // Size: 0
		public const int CZ_MAKE_ITEM_FROM_DRESS_ROOM = 0xF35; // Size: 150
		public const int ZC_START_CASUAL_GAMBLE = 0xF36; // Size: 0
		public const int ZC_CASUAL_GAMBLE_ITEM_GET = 0xF37; // Size: 18
		public const int CZ_REQUEST_CASUAL_GAMBLE = 0xF38; // Size: 22
		public const int ZC_END_CASUAL_GAMBLE = 0xF39; // Size: 10
		public const int CZ_REQUEST_COMMON_GAMBLE = 0xF3A; // Size: 158
		public const int ZC_COMMON_GAMBLE_ITEM_GET = 0xF3B; // Size: 18
		public const int ZC_WEEKLY_BOSS_RANK_INFO = 0xF3C; // Size: 0
		public const int ZC_WEEKLY_BOSS_RANK_MY_DAMAGE = 0xF3D; // Size: 22
		public const int ZC_WEEKLY_BOSS_ACCUMULATED_DAMAGE = 0xF3E; // Size: 22
		public const int ZC_WEEKLY_BOSS_ABSOLUTE_REWARD_LIST = 0xF3F; // Size: 0
		public const int ZC_WEEKLY_BOSS_RECEIVED_ABSOLUTE_REWARD_LIST = 0xF40; // Size: 0
		public const int CZ_REQUEST_WEEKLY_BOSS_ABSOLUTE_REWARD_LIST = 0xF41; // Size: 26
		public const int CZ_REQUEST_WEEKLY_BOSS_RECEIVE_ABSOLUTE_REWARD = 0xF42; // Size: 26
		public const int CZ_REQUEST_WEEKLY_BOSS_CLASS_RANKING_REWARD = 0xF43; // Size: 30
		public const int ZC_WEEKLY_BOSS_RECEIVED_RANKING_REWARD = 0xF44; // Size: 18
		public const int ZC_WEEKLY_BOSS_RANKING_REWARD_LIST = 0xF45; // Size: 0
		public const int ZC_WEEKLY_BOSS_CLASS_RANKING_REWARD_LIST = 0xF46; // Size: 0
		public const int CZ_REQUEST_WEEKLY_BOSS_RANKING_REWARD_LIST = 0xF47; // Size: 26
		public const int CZ_REQUEST_WEEKLY_BOSS_RECEIVE_RANKING_REWARD = 0xF48; // Size: 26
		public const int CZ_REQUEST_WEEKLY_BOSS_ACCEPT_ABSOLUTE_REWARD = 0xF49; // Size: 34
		public const int CZ_REQUEST_WEEKLY_BOSS_ACCEPT_ABSOLUTE_REWARD_ALL = 0xF4A; // Size: 26
		public const int CZ_REQUEST_WEEKLY_BOSS_ACCEPT_RANKING_REWARD = 0xF4B; // Size: 30
		public const int CZ_REQUEST_WEEKLY_BOSS_ACCEPT_CLASS_RANKING_REWARD = 0xF4C; // Size: 34
		public const int CZ_REQUEST_WEEKLY_BOSS_RANKING_INFO_LIST = 0xF4D; // Size: 28
		public const int CZ_REQUEST_WEEKLY_BOSS_NOW_WEEK_NUM = 0xF4E; // Size: 22
		public const int CZ_REQUEST_WEEKLY_BOSS_START_TIME = 0xF4F; // Size: 26
		public const int CZ_REQUEST_WEEKLY_BOSS_END_TIME = 0xF50; // Size: 26
		public const int CZ_REQUEST_WEEKLY_BOSS_PATTERN_INFO = 0xF51; // Size: 26
		public const int ZC_WEEKLY_BOSS_NOW_WEEK_NUM = 0xF52; // Size: 14
		public const int ZC_WEEKLY_BOSS_START_TIME = 0xF53; // Size: 26
		public const int ZC_WEEKLY_BOSS_END_TIME = 0xF54; // Size: 26
		public const int ZC_WEEKLY_BOSS_PATTERN_INFO = 0xF55; // Size: 0
		public const int ZC_WEEKLY_BOSS_RECEIVED_CLASS_RANKING_REWARD = 0xF56; // Size: 0
		public const int CZ_REQUEST_WEEKLY_BOSS_RECEIVE_CLASS_RANKING_REWARD = 0xF57; // Size: 26
		public const int CZ_REQUEST_WEEKLY_BOSS_ENABLE_CLASS_RANKING_SEASON = 0xF58; // Size: 26
		public const int ZC_REQUEST_WEEKLY_BOSS_ENABLE_CLASS_RANKING_SEASON = 0xF59; // Size: 11
		public const int CZ_REQUEST_DPS_START = 0xF5A; // Size: 22
		public const int ZC_REQUEST_DPS_START = 0xF5B; // Size: 26
		public const int CZ_MYTHIC_DUNGEON_REQUEST_RANK_INFO = 0xF5C; // Size: 29
		public const int CZ_MYTHIC_DUNGEON_REQUEST_PATTERN = 0xF5D; // Size: 24
		public const int ZC_MYTHIC_DUNGEON_RANK_INFO = 0xF5E; // Size: 0
		public const int CZ_MYTHIC_DUNGEON_REQUEST_CURRENT_SEASON = 0xF5F; // Size: 22
		public const int ZC_MYTHIC_DUNGEON_CURRENT_SEASON = 0xF60; // Size: 44
		public const int ZC_MYTHIC_DUNGEON_PATTERN_INFO = 0xF61; // Size: 0
		public const int ZC_FIELD_BOSS_PATTERN_INFO = 0xF62; // Size: 0
		public const int CZ_REQUEST_FIELD_BOSS_PATTERN_INFO = 0xF63; // Size: 38
		public const int CZ_REQUEST_FIELD_BOSS_RANKING_INFO = 0xF64; // Size: 38
		public const int ZC_FIELD_BOSS_RANKING_INFO = 0xF65; // Size: 0
		public const int CZ_REQUEST_BORUTA_REWARD = 0xF66; // Size: 30
		public const int ZC_SEND_BORUTA_RANK_LIST = 0xF67; // Size: 0
		public const int CZ_REQUEST_BORUTA_RANK_LIST = 0xF68; // Size: 30
		public const int CZ_REQUEST_ACCEPT_REWARD_INFO = 0xF69; // Size: 30
		public const int ZC_RESPONSE_ACCEPT_REWARD_INFO = 0xF6A; // Size: 15
		public const int CZ_REQUEST_BORUTA_NOW_WEEK_NUM = 0xF6B; // Size: 22
		public const int ZC_RESPONSE_BORUTA_NOW_WEEK_NUM = 0xF6C; // Size: 14
		public const int CZ_REQUEST_BORUTA_START_TIME = 0xF6D; // Size: 26
		public const int ZC_BORUTA_START_TIME = 0xF6E; // Size: 26
		public const int CZ_REQUEST_BORUTA_END_TIME = 0xF6F; // Size: 26
		public const int ZC_BORUTA_END_TIME = 0xF70; // Size: 26
		public const int CZ_RECEIVE_PERSONAL_RANK_REWARD = 0xF71; // Size: 38
		public const int CZ_ADD_PARTY_INFO = 0xF72; // Size: 310
		public const int CZ_UPDATE_PARTY_INFO = 0xF73; // Size: 310
		public const int CZ_REMOVE_PARTY_INFO = 0xF74; // Size: 22
		public const int CZ_REQUEST_FIND_PARTY_JOIN = 0xF75; // Size: 87
		public const int ZC_CONFIRM_FIND_PARTY_JOIN = 0xF76; // Size: 103
		public const int CZ_CONFIRM_FIND_PARTY_JOIN = 0xF77; // Size: 88
		public const int CZ_HOUSING_OPEN_EDIT_MODE = 0xF78; // Size: 10
		public const int CZ_HOUSING_CLOSE_EDIT_MODE = 0xF79; // Size: 10
		public const int CZ_HOUSING_REQUEST_GRID_ARRANGED_FURNITURE = 0xF7A; // Size: 22
		public const int CZ_HOUSING_REQUEST_ARRANGED_FURNITURE = 0xF7B; // Size: 22
		public const int ZC_HOUSING_READY_GRID = 0xF7C; // Size: 0
		public const int ZC_HOUSING_READY_ARRANGED_FURNITURE = 0xF7D; // Size: 0
		public const int ZC_HOUSING_ANSWER_ARRANGED_FURNITURE = 0xF7E; // Size: 0
		public const int ZC_HOUSING_START_ARRANGEMENT_FURNITURE = 0xF7F; // Size: 14
		public const int CZ_HOUSING_REQUEST_ARRANGEMENT_FURNITURE = 0xF80; // Size: 0
		public const int CZ_HOUSING_CANCEL_ARRANGEMENT_FURNITURE = 0xF81; // Size: 23
		public const int CZ_HOUSING_REQUEST_REMOVE_FURNITURE = 0xF82; // Size: 30
		public const int CZ_HOUSING_REQUEST_REMOVE_FURNITURE_ALOT = 0xF83; // Size: 0
		public const int CZ_HOUSING_REQUEST_REMOVE_ALL_FURNITURE = 0xF84; // Size: 22
		public const int ZC_HOUSING_ANSWER_REMOVE_FURNITURE = 0xF85; // Size: 18
		public const int CZ_HOUSING_REQUEST_ENABLE_MOVE_FURNITURE = 0xF86; // Size: 30
		public const int ZC_HOUSING_ANSWER_ENABLE_MOVE_FURNITURE = 0xF87; // Size: 18
		public const int CZ_HOUSING_REQUEST_MOVE_FURNITURE = 0xF88; // Size: 0
		public const int CZ_HOUSING_REQUEST_GUILD_AGIT_INFO = 0xF89; // Size: 158
		public const int ZC_HOUSING_ANSWER_GUILD_AGIT_INFO = 0xF8A; // Size: 154
		public const int CZ_HOUSING_REQUEST_GUILD_AGIT_EXTENSION = 0xF8B; // Size: 150
		public const int CZ_HOUSING_REQUEST_GUILD_LAB_USE_RESEARCH = 0xF8C; // Size: 27
		public const int CZ_HOUSING_REQUEST_GUILD_LAB_LEVEL_UP = 0xF8D; // Size: 27
		public const int CZ_HOUSING_REQUEST_GUILD_LAB_RESEARCH_LEVEL_UP = 0xF8E; // Size: 26
		public const int CZ_HOUSING_REQUEST_GUILD_CONTRIBUTION_TO_MILEAGE = 0xF8F; // Size: 26
		public const int CZ_HOUSING_REQUEST_GUILD_MILEAGE_TO_CONTRIBUTION = 0xF90; // Size: 26
		public const int CZ_HOUSING_REQUEST_GUILD_CONTIRUBTION_DISTRIBUTE = 0xF91; // Size: 0
		public const int CZ_HOUSING_REQUEST_GUILD_POINT_UP = 0xF92; // Size: 166
		public const int CZ_HOUSING_REQUEST_HOUSING_SHOP_TRADE = 0xF93; // Size: 0
		public const int ZC_HOUSING_CREATE_BG_FURNITURE = 0xF94; // Size: 31
		public const int ZC_HOUSING_MOVE_BG_FURNITURE = 0xF95; // Size: 27
		public const int ZC_HOUSING_REMOVE_BG_FURNITURE = 0xF96; // Size: 14
		public const int CZ_HOUSING_PAGE_SAVE = 0xF97; // Size: 90
		public const int CZ_HOUSING_PAGE_LOAD = 0xF98; // Size: 26
		public const int CZ_HOUSING_PAGE_DELETE = 0xF99; // Size: 26
		public const int CZ_PERSONAL_HOUSING_REQUEST_LEAVE = 0xF9A; // Size: 22
		public const int CZ_PERSONAL_HOUSING_REQUEST_BUY_BACKGROUND = 0xF9B; // Size: 26
		public const int CZ_PERSONAL_HOUSING_REQUEST_APPLY_BACKGROUND = 0xF9C; // Size: 26
		public const int CZ_HOUSING_REQUEST_PREVIEW = 0xF9D; // Size: 39
		public const int ZC_HOUSING_ANSWER_PREVIEW = 0xF9E; // Size: 0
		public const int CZ_HOUSING_REQUEST_POST_HOUSE_WARP = 0xF9F; // Size: 34
		public const int CZ_PERSONAL_HOUSING_REQUEST_GROUP_LIST = 0xFA0; // Size: 22
		public const int ZC_PERSONAL_HOUSING_ANSWER_GROUP_LIST = 0xFA1; // Size: 0
		public const int ZC_REBUILD_POPUP = 0xFA2; // Size: 10
		public const int ZC_ANCIENT_CARD_ADD = 0xFA3; // Size: 0
		public const int ZC_ANCIENT_CARD_REMOVE = 0xFA4; // Size: 30
		public const int ZC_ANCIENT_CARD_COMBINE = 0xFA5; // Size: 0
		public const int ZC_ANCIENT_CARD_EVOLVE = 0xFA6; // Size: 0
		public const int ZC_ANCIENT_CARD_LOCK = 0xFA7; // Size: 31
		public const int ZC_ANCIENT_CARD_UPDATE = 0xFA8; // Size: 0
		public const int ZC_ANCIENT_CARD_RESET = 0xFA9; // Size: 22
		public const int ZC_ANCIENT_CARD_LOAD = 0xFAA; // Size: 0
		public const int ZC_ANCIENT_CARD_EXP_UP = 0xFAB; // Size: 42
		public const int ZC_ANCIENT_MONSTER_SUMMON = 0xFAC; // Size: 42
		public const int ZC_ANCIENT_MONSTER_DEAD = 0xFAD; // Size: 30
		public const int CZ_ANCIENT_CARD_SELL = 0xFAE; // Size: 30
		public const int CZ_ANCIENT_CARD_SWAP = 0xFAF; // Size: 34
		public const int CZ_ANCIENT_MON_ALLKILL = 0xFB0; // Size: 22
		public const int CZ_ANCIENT_CARD_COMBINE = 0xFB1; // Size: 0
		public const int CZ_ANCIENT_CARD_EVOLVE = 0xFB2; // Size: 0
		public const int CZ_ANCIENT_CARD_LOCK = 0xFB3; // Size: 30
		public const int CZ_FORCE_SKILL_RANGE = 0xFB4; // Size: 54
		public const int CZ_VARIABLE_RANGE_RESULT = 0xFB5; // Size: 38
		public const int CZ_CANCEL_PAIR_ANIMATION = 0xFB6; // Size: 22
		public const int ZC_SET_DAYLIGHT_INFO = 0xFB7; // Size: 0
		public const int ZC_DAYLIGHT_SYNCHRONIZE_TIME = 0xFB8; // Size: 14
		public const int ZC_DAYLIGHT_FIXED = 0xFB9; // Size: 36
		public const int CZ_SELECTED_LANGUAGE = 0xFBA; // Size: 24
		public const int CZ_ACCEPT_FIELD_DUNGEON_REJOIN = 0xFBB; // Size: 22
		public const int CZ_UDP_MOVE_INFO = 0xFBC; // Size: 80
		public const int ZC_UDP_MOVE_INFO = 0xFBD; // Size: 79
		public const int ZC_UDP_MULTI_PACKET = 0xFBE; // Size: 12810
		public const int ZC_MAIN_SECTOR_INFO = 0xFBF; // Size: 0
		public const int ZC_ADD_CHATBALLOON_SKIN = 0xFC0; // Size: 0
		public const int CZ_SET_CHATBALLOON_SKIN = 0xFC1; // Size: 26
		public const int ZC_SET_CHATBALLOON_SKIN = 0xFC2; // Size: 34
		public const int ZC_UPDATE_CHATBALLOON_SKIN = 0xFC3; // Size: 10
		public const int ZC_AUTOSELLER_LIST = 0xFC4; // Size: 0
		public const int ZC_AUTOSELLER_TITLE = 0xFC5; // Size: 91
		public const int CZ_DO_CLIENT_MOVE_CHECK = 0xFC6; // Size: 22
		public const int ZC_IS_SUMMONING_MONSTER = 0xFC7; // Size: 15
		public const int ZC_IS_SUMMON_SORCERER_MONSTER = 0xFC8; // Size: 15
		public const int CZ_SUMMON_PET = 0xFC9; // Size: 38
		public const int CZ_SELECT_GROUND_POS_START = 0xFCA; // Size: 22
		public const int CZ_SELECT_GROUND_POS_END = 0xFCB; // Size: 22
		public const int CZ_REQ_DAMAGEFONT_SKIN = 0xFCC; // Size: 26
		public const int CZ_SET_DAMAGEFONT_SKIN = 0xFCD; // Size: 30
		public const int ZC_RES_DAMAGEFONT_SKIN = 0xFCE; // Size: 30
		...
		public const int CZ_REQ_APPLY_HUD_SKIN = 0x1058; // Size: 26
		public const int CZ_REQ_CURRENT_HUD_SKIN = 0x1059; // Size: 23
		public const int ZC_SEND_MODE_HUD_SKIN = 0x105A; // Size: 15
		public const int ZC_SEND_APPLY_HUD_SKIN_MYSELF = 0x105B; // Size: 18
		public const int ZC_SEND_APPLY_HUD_SKIN_PARTY = 0x105C; // Size: 26
		public const int ZC_SEND_APPLY_HUD_SKIN_OTHER = 0x105D; // Size: 18
		public const int CZ_REQ_FIELD_BOSS_INDUN_REENTER_CHECK = 0x105E; // Size: 26
		public const int ZC_SEND_FIELD_BOSS_INDUN_REENTER_CHECK = 0x105F; // Size: 19
		public const int CZ_REQ_FULLSCREEN_MOVE_NPC = 0x1060; // Size: 2200
		public const int ZC_VERTIGO_GAMES_USER_BALANCE = 0x1061; // Size: 30
		public const int CZ_BUY_VERTIGO_GAMES_PRODUCT = 0x1062; // Size: 170
		public const int ZC_CHANGE_QUICKSLOT_INIT = 0x1063; // Size: 1046
		public const int CZ_REQ_QUICKSLOT_REFRESH = 0x1064; // Size: 22
		public const int ZC_SET_AURA_INTENSIVE_INFO = 0x1065; // Size: 18
		public const int ZC_UPDATE_SKL_SPDRATE_LIST = 0x1066; // Size: 0
		public const int ZC_CHARACTER_INDUN_INFO_RESPONSE = 0x1067; // Size: 0
