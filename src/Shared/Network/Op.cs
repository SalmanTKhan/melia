...
namespace Melia.Shared.Network
{
	...
	public static class Op
	{
		...
		public const int CZ_REQ_DAMAGEEFFECT_SKIN = 0xFCE; // Size: 26
		public const int CZ_SET_DAMAGEEFFECT_SKIN = 0xFCF; // Size: 30
		public const int ZC_RES_DAMAGEEFFECT_SKIN = 0xFD0; // Size: 30
		public const int CZ_REQUEST_GODDESS_ROULETT = 0xFD1; // Size: 26
		public const int CZ_REQUEST_GODDESS_ROULETT_STATE = 0xFD2; // Size: 26
		public const int ZC_OVERHEAT_RESET_TIME = 0xFD3; // Size: 26
		public const int CZ_PERSONAL_HOUSING_SHOP_PAYMENT = 0xFD4; // Size: 0
		public const int CZ_START_SERVER_TRACING = 0xFD5; // Size: 22
		public const int CZ_PERSONAL_HOUSING_BOARD_LOG = 0xFD6; // Size: 2082
		public const int ZC_TAUNT_START = 0xFD7; // Size: 23
		public const int ZC_TAUNT_END = 0xFD8; // Size: 14
		public const int CZ_CHECK_USE_NAME = 0xFD9; // Size: 470
		public const int CZ_REQ_FIELD_BOSS_EXIST = 0xFDA; // Size: 22
		public const int ZC_RESPONSE_FIELD_BOSS_EXIST = 0xFDB; // Size: 0
		public const int CZ_ACCOUNT_ABILITY_LEVELUP = 0xFDC; // Size: 90
		public const int CZ_ACCOUNT_ABILITY_RESET = 0xFDD; // Size: 86
		public const int ZC_BREATH_ATTACK_TARGET_CAHSE = 0xFDE; // Size: 78
		public const int CZ_BREATH_ATTACK_TARGET_CAHSE_RESULT = 0xFDF; // Size: 294
		public const int CZ_OPEN_SHOP_LOG = 0xFE0; // Size: 55
		public const int CZ_SELECT_PARTY_BUFF = 0xFE1; // Size: 26
		public const int CZ_SELECT_SOLO_BUFF = 0xFE2; // Size: 30
		public const int CZ_REPUTATION_SHOP_TRADE = 0xFE3; // Size: 0
		public const int ZC_RELIC_RP_CHANGE = 0xFE4; // Size: 14
		public const int CZ_REQUEST_RANK_SYSTEM_TIME_TABLE = 0xFE5; // Size: 26
		public const int ZC_RESPONSE_RANK_SYSTEM_TIME_TABLE = 0xFE6; // Size: 0
		public const int CZ_REQUEST_RANK_SYSTEM_RANK_LIST = 0xFE7; // Size: 42
		public const int ZC_RESPONSE_RANK_SYSTEM_RANK_LIST = 0xFE8; // Size: 0
		public const int CZ_REQUEST_RANK_SYSTEM_MY_DATA = 0xFE9; // Size: 42
		public const int ZC_RESPONSE_RANK_SYSTEM_MY_DATA = 0xFEA; // Size: 0
		public const int ZC_RANK_SYSTEM_RECEIVED_REWARD_INFO_LIST = 0xFEB; // Size: 0
		public const int ZC_RANK_SYSTEM_RECEIVED_REWARD_INFO = 0xFEC; // Size: 38
		public const int CZ_REQUEST_DRAW_TOSHERO_EMBLEM = 0xFED; // Size: 26
		public const int ZC_RESPONSE_DRAW_TOSHERO_EMBLEM = 0xFEE; // Size: 0
		public const int CZ_UDP_HOLEPUNCH = 0xFEF; // Size: 22
		public const int ZC_UDP_HOLEPUNCH_ACK = 0xFF0; // Size: 10
		public const int CZ_REQ_CHALLENGE_AUTOMATCH_UI_OPEN = 0xFF1; // Size: 26
		public const int ZC_MONSTER_CANCEL_CASTING_UI = 0xFF2; // Size: 26
		public const int CZ_DIALOG_SELECT_MULTIPLE = 0xFF3; // Size: 0
		public const int CZ_REQ_RAID_AUTOMATCH_UI_OPEN = 0xFF4; // Size: 26
		public const int CZ_REQ_RAID_SOLO_UI_OPEN = 0xFF5; // Size: 26
		public const int CZ_REQ_TOSHERO_ENTER = 0xFF6; // Size: 26
		public const int CZ_REQ_EARRING_RAID_ENTER = 0xFF7; // Size: 26
		public const int CZ_REQ_PILGRIM_ENTER = 0xFF8; // Size: 26
		public const int CZ_REQ_LEVEL_DUNGEON_ENTER = 0xFF9; // Size: 26
		public const int CZ_REQ_USE_RAID_AUTO_SWEEP = 0xFFA; // Size: 26
		public const int CZ_REQ_BRIDGE_WAILING = 0xFFB; // Size: 26
		public const int CZ_REQUEST_CARD_PRESET = 0xFFC; // Size: 26
		public const int ZC_RESPONSE_CARD_PRESET = 0xFFD; // Size: 0
		public const int CZ_SET_CARD_PRESET = 0xFFE; // Size: 0
		public const int CZ_SET_CARD_PRESET_TITLE = 0xFFF; // Size: 90
		public const int ZC_TOSHERO_INFO = 0x1000; // Size: 58
		public const int ZC_TOSHERO_POINT_INFO = 0x1001; // Size: 14
		public const int ZC_TOSHERO_BUFFSHOP_INFO = 0x1002; // Size: 0
		public const int CZ_TOSHERO_BUY_BUFF = 0x1003; // Size: 26
		public const int CZ_TOSHERO_SELL_BUFF = 0x1004; // Size: 26
		public const int CZ_TOSHERO_SELECT_BUFF = 0x1005; // Size: 26
		public const int CZ_TOSHERO_UPGRADE_BUFF = 0x1006; // Size: 26
		public const int CZ_TOSHERO_DESELECT_BUFF = 0x1007; // Size: 22
		public const int CZ_TOSHERO_COMBINE_THREE_BUFF = 0x1008; // Size: 46
		public const int CZ_TOSHERO_CHANGE_ATTRIBUTE = 0x1009; // Size: 26
		public const int CZ_TOSHERO_RUN_LOTTERY = 0x100A; // Size: 26
		public const int CZ_TOSHERO_REINFORCE = 0x100B; // Size: 30
		public const int CZ_TOSHERO_CHANGE_EQUIP_OPTION = 0x100C; // Size: 34
		public const int CZ_TOSHERO_READY = 0x100D; // Size: 26
		public const int ZC_START_RANGE_PREVIEW = 0x100E; // Size: 151
		public const int ZC_END_RANGE_PREVIEW = 0x100F; // Size: 74
		public const int ZC_CLEAR_RANGE_PREVIEW = 0x1010; // Size: 10
		public const int ZC_FIX_DIRECTION = 0x1011; // Size: 78
		public const int ZC_FIX_DIRECTION_END = 0x1012; // Size: 14
		public const int CZ_REQ_TOGGLE_ABILITY = 0x1013; // Size: 26
		public const int ZC_MY_CHARACTER_LIST = 0x1014; // Size: 0
		public const int CZ_REG_CHANGE_CHARACTER_SLOT = 0x1015; // Size: 30
		public const int CZ_DEREG_CHANGE_CHARACTER_SLOT = 0x1016; // Size: 34
		public const int ZC_START_CHARACTER_CHANGE = 0x1017; // Size: 26
		public const int ZC_FINISH_CHARACTER_CHANGE = 0x1018; // Size: 30
		public const int CZ_REQ_CHARACTER_CHANGE = 0x1019; // Size: 34
		public const int ZC_CHARACTER_CHANGE_REGIST_COMPLETE = 0x101A; // Size: 22
		public const int ZC_CHARACTER_CHANGE_DEREGIST_COMPLETE = 0x101B; // Size: 14
		public const int ZC_MY_CHARACTER_DECK_LIST = 0x101C; // Size: 0
		public const int CZ_REQ_FAVORITE_INDUN_SET = 0x101D; // Size: 55
		public const int ZC_EQUIP_DUMMY_FOR_SKILL = 0x101E; // Size: 22
		public const int CZ_REQUEST_AETHER_GEM_REINFORCE = 0x101F; // Size: 38
		public const int ZC_SET_AURA_INFO = 0x1020; // Size: 279
		public const int CZ_OPEN_HELP = 0x1021; // Size: 86
		public const int CZ_REQ_UNKNOWN_SANTUARTY_BUFF = 0x1022; // Size: 346
		public const int ZC_SEND_CURRENT_JOIN_MGAME_NAME = 0x1023; // Size: 266
		public const int CZ_REQ_SUMMON_RIDE_PET = 0x1024; // Size: 26
		public const int CZ_REQ_SELECT_RIDE_PET = 0x1025; // Size: 26
		public const int CZ_ANS_GIVEUP_PREV_PLAYING_INDUN_PARTY = 0x1026; // Size: 23
		public const int CZ_LOCK_COLONY_ZONE_ENTER = 0x1027; // Size: 24
		public const int CZ_DICE = 0x1028; // Size: 27
		public const int ZC_SET_PLAYER_CONTENTS_RECORD_RESULT = 0x1029; // Size: 150
		public const int ZC_SEND_TEAM_BATTLE_LEAGUE_RESULT_LIST = 0x102A; // Size: 0
		public const int ZC_SEND_TEAM_BATTLE_LEAGUE_DETAIL_DAMAGE_LIST = 0x102B; // Size: 0
		public const int ZC_SEND_TEAM_BATTLE_LEAGUE_DETAIL_HEAL_LIST = 0x102C; // Size: 0
		public const int ZC_TEAM_BATTLE_LEAGUE_OBSERVE_RELEASE_LOCK_MOVE_KEY = 0x102D; // Size: 10
		public const int ZC_START_COMBO_INPUT_CMD = 0x102E; // Size: 0
		public const int ZC_END_COMBO_INPUT_CMD = 0x102F; // Size: 14
		public const int CZ_END_COMBO_INPUT = 0x1030; // Size: 27
		public const int CZ_CONTENTS_ALERT_MOVE = 0x1031; // Size: 22
		public const int ZC_TIMING_GAUGE_START = 0x1032; // Size: 54
		public const int ZC_TIMING_GAUGE_END = 0x1033; // Size: 15
		public const int ZC_CHARGING_GAUGE_START = 0x1034; // Size: 59
		public const int ZC_CHARGING_GAUGE_END = 0x1035; // Size: 15
		public const int ZC_INTERACTION_RIDE = 0x1036; // Size: 555
		public const int ZC_INTERACTION_COOL_TIME = 0x1037; // Size: 23
		public const int ZC_SQUAD_INFO = 0x1038; // Size: 0
		public const int CZ_INVITE_SQUAD_MEMBER = 0x1039; // Size: 91
		public const int ZC_INVITE_SQUAD_MEMBER = 0x103A; // Size: 217
		public const int CZ_RESPONSE_INVITED_SQUAD = 0x103B; // Size: 88
		public const int CZ_LEAVE_SQUAD = 0x103C; // Size: 95
		public const int CZ_CREATE_SQUAD = 0x103D; // Size: 91
		public const int CZ_DISBAND_SQUAD = 0x103E; // Size: 26
		public const int CZ_REQ_EARRING_RAID_PARTY_SKILL = 0x103F; // Size: 26
		public const int ZC_CUSTOM_CAMERA_ZOOM = 0x1040; // Size: 22
		public const int ZC_SHOW_SCENE_MODEL_LOCAL = 0x1041; // Size: 19
		public const int ZC_ADD_PAD_VISIBLE_OPTION = 0x1042; // Size: 16
		public const int ZC_REMOVE_PAD_VISIBLE_OPTION = 0x1043; // Size: 14
		public const int ZC_MGAME_USER_DAMAGE_LIST = 0x1044; // Size: 0
		public const int ZC_SEND_TRIBULATION_INFO = 0x1045; // Size: 0
		public const int CZ_REQ_TRIBULATION_INFO = 0x1046; // Size: 539
		public const int CZ_SEND_SELECTED_TRIBULATION_INFO = 0x1047; // Size: 0
		public const int ZC_SEND_SELECTED_TRIBULATION_INFO = 0x1048; // Size: 0
		public const int ZC_SEND_TRIBULATION_CLEAR = 0x1049; // Size: 282
		public const int CZ_SAVE_CLASS_SNAPSHOT = 0x104A; // Size: 52
		public const int CZ_RENAME_CLASS_SNAPSHOT = 0x104B; // Size: 50
		public const int CZ_UNEQUIP_ITEM_ALL = 0x104C; // Size: 22
		public const int CZ_APPLY_CLASS_SNAPSHOT = 0x104D; // Size: 26
		public const int CZ_REMOVE_CLASS_SNAPSHOT = 0x104E; // Size: 26
		public const int CZ_REQ_RUNSCRIPT = 0x104F; // Size: 22
		public const int CZ_REQ_TRANSLATE_MSG = 0x1050; // Size: 2107
		public const int ZC_SEND_TRANSLATED_MSG = 0x1051; // Size: 2111
		public const int ZC_SET_SOUND_MUTE = 0x1052; // Size: 16
		public const int ZC_SET_MUSIC_MUTE = 0x1053; // Size: 16
		public const int ZC_BREAK_SHIELD = 0x1054; // Size: 14
		public const int ZC_SHOW_MON_CASTING_UI = 0x1055; // Size: 538
		public const int CZ_REQ_RAID_GIVE_UP = 0x1056; // Size: 26
		public const int CZ_REQ_APPLY_HUD_SKIN = 0x1057; // Size: 26
		public const int CZ_REQ_CURRENT_HUD_SKIN = 0x1058; // Size: 23
		public const int ZC_SEND_MODE_HUD_SKIN = 0x1059; // Size: 15
		public const int ZC_SEND_APPLY_HUD_SKIN_MYSELF = 0x105A; // Size: 18
		public const int ZC_SEND_APPLY_HUD_SKIN_PARTY = 0x105B; // Size: 26
		public const int ZC_SEND_APPLY_HUD_SKIN_OTHER = 0x105C; // Size: 18
