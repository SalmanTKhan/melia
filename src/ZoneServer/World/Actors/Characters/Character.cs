...
namespace Melia.Zone.World.Actors.Characters
{
	...
	public class Character : Actor, IActor, ICombatEntity, ICommander, IPropertyObject, IUpdateable
	{
		...
		{
			Color.FromArgb(255, 107, 103, 100);
		...
		public void SendPCEtcProperties()
		{
			...
			{
				if (ZoneServer.Instance.Data.SkintoneDb.TryFind(this.Skin, out var skinData))
					this.EtcProperties.SetString(PropertyName.SkintoneName, skinData.ClassName);
				if (ZoneServer.Instance.Data.HairTypeDb.TryFind(this.Gender, this.Hair, out var hair))
