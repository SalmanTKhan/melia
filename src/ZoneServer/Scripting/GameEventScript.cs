...
namespace Melia.Zone.Scripting
{
	...
	public abstract class GameEventScript : GeneralScript
	{
		...
		{
			ZoneServer.Instance.GameEvents.GlobalBonuses.AddBonus(this.Id, this.Name, stat, multiplier);
		}
		...
		{
			ZoneServer.Instance.GameEvents.GlobalBonuses.RemoveBonuses(this.Id);
		}
		...
		{
			ZoneServer.Instance.GameEvents.GlobalBonuses.AddBuff(this.Id, this.Name, buffId, numArg1, numArg2);
		}

		/// <summary>
		/// Removes all global buffs associated with this event.
		/// </summary>
		protected void RemoveGlobalBuffs()
		{
			ZoneServer.Instance.GameEvents.GlobalBonuses.RemoveBuffs(this.Id);
		}
