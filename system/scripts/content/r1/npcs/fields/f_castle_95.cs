...
public class FCastle95NpcScript : GeneralScript
{
	public override void Load()
	{
		...
		//-------------------------------------------------------------------------
		AddNpc(4, 156117, "Resistance Adjutant Antanina", "f_castle_95", -1026.745, 86.57175, -442.8207, 0, "CASTLE95_NPC_MAIN01", "", "", 0);
		
		// Detachment Soldier
		//-------------------------------------------------------------------------
		AddNpc(5, 150180, "Detachment Soldier", "f_castle_95", -1023.379, 86.57175, -392.1639, 0, "CASTLE95_NPC_01", "", "", 0);
		
		// Detachment Soldier
		//-------------------------------------------------------------------------
		AddNpc(12, 155163, "Detachment Soldier", "f_castle_95", -977.2556, 86.57175, -393.53, 0, "CASTLE95_NPC_02", "", "", 0);
		
		// Detachment Soldier
		//-------------------------------------------------------------------------
		AddNpc(15, 155165, "Detachment Soldier", "f_castle_95", -1077.17, 86.57175, -393.1283, 0, "CASTLE95_NPC_03", "", "", 0);
		
		// 
		//-------------------------------------------------------------------------
		AddNpc(16, 147414, "", "f_castle_95", 858.719, 32.34813, -733.5207, 90, "CASTLE95_OBELISK_01", "", "", 0);
		
		// 
		//-------------------------------------------------------------------------
		AddNpc(41, 147501, "", "f_castle_95", 858.719, 32.34813, -733.5207, 90, "CASTLE95_OBELISK_01_BROKEN", "", "", 1);
		
		// 
		//-------------------------------------------------------------------------
		AddNpc(17, 147414, "", "f_castle_95", 175, 292, 316, 90, "CASTLE95_OBELISK_02", "", "", 0);
		
		// 
		//-------------------------------------------------------------------------
		AddNpc(42, 147501, "", "f_castle_95", 175, 292, 316, 90, "CASTLE95_OBELISK_02_BROKEN", "", "", 1);
		
		// Portal
		//-------------------------------------------------------------------------
		AddNpc(18, 154067, "Portal", "f_castle_95", 1626, 377, 1076, 90, "CASTLE95_PORTAL", "", "", 1);
		
		// Resistance Adjutant Antanina
		//-------------------------------------------------------------------------
		AddNpc(19, 156117, "Resistance Adjutant Antanina", "f_castle_95", 1679, 281, 447, 0, "CASTLE95_NPC_MAIN02", "", "", 1);
		
		// Detachment Soldier
		//-------------------------------------------------------------------------
		AddNpc(20, 150180, "Detachment Soldier", "f_castle_95", 1568, 281, 444, 45, "CASTLE95_NPC_04", "", "", 1);
		
		// Detachment Soldier
		//-------------------------------------------------------------------------
		AddNpc(21, 155163, "Detachment Soldier", "f_castle_95", 1576, 281, 338, 135, "CASTLE95_NPC_05", "", "", 1);
		
		// Detachment Soldier
		//-------------------------------------------------------------------------
		AddNpc(22, 155165, "Detachment Soldier", "f_castle_95", 1680, 281, 331, 270, "CASTLE95_NPC_06", "", "", 1);
		...
		//  
		//-------------------------------------------------------------------------
		AddNpc(30, 151018, " ", "f_castle_95", 800, 32, -788, 45, "CASTLE95_SETTING_POINT_01", "", "", 0);
		
		//  
		//-------------------------------------------------------------------------
		AddNpc(31, 151018, " ", "f_castle_95", 804, 32, -676, 45, "CASTLE95_SETTING_POINT_02", "", "", 0);
		
		//  
		//-------------------------------------------------------------------------
		AddNpc(32, 151018, " ", "f_castle_95", 908, 32, -679, 45, "CASTLE95_SETTING_POINT_03", "", "", 0);
		
		//  
		//-------------------------------------------------------------------------
		AddNpc(33, 151018, " ", "f_castle_95", 904, 32, -788, 45, "CASTLE95_SETTING_POINT_04", "", "", 0);
		
		//  
		//-------------------------------------------------------------------------
		AddNpc(34, 151067, " ", "f_castle_95", 800, 32, -788, 135, "CASTLE95_SETTING_POINT_BOX_01", "", "", 1);
		
		//  
		//-------------------------------------------------------------------------
		AddNpc(35, 151067, " ", "f_castle_95", 804, 32, -676, 135, "CASTLE95_SETTING_POINT_BOX_02", "", "", 1);
		
		//  
		//-------------------------------------------------------------------------
		AddNpc(36, 151067, " ", "f_castle_95", 908, 32, -679, 135, "CASTLE95_SETTING_POINT_BOX_03", "", "", 1);
		
		//  
		//-------------------------------------------------------------------------
		AddNpc(37, 151067, " ", "f_castle_95", 904, 32, -788, 135, "CASTLE95_SETTING_POINT_BOX_04", "", "", 1);
		...
		// 
		//-------------------------------------------------------------------------
		AddNpc(40, 147414, "", "f_castle_95", 1578.139, 49.92593, -671.3681, 90, "CASTLE95_OBELISK_04", "", "", 0);
		
		// 
		//-------------------------------------------------------------------------
		AddNpc(39, 147414, "", "f_castle_95", 1327.575, 21.16457, -1793.358, 90, "CASTLE95_OBELISK_03", "", "", 0);
		
		// 
		//-------------------------------------------------------------------------
		AddNpc(44, 147501, "", "f_castle_95", 1578.139, 49.92593, -671.3681, 90, "CASTLE95_OBELISK_04_BROKEN", "", "", 1);
		
		// 
		//-------------------------------------------------------------------------
		AddNpc(43, 147501, "", "f_castle_95", 1327.575, 21.16457, -1793.358, 90, "CASTLE95_OBELISK_03_BROKEN", "", "", 1);
		...
		//  
		//-------------------------------------------------------------------------
		AddNpc(48, 151064, " ", "f_castle_95", 1630.63, 377.02, 1053.86, 0, "CASTLE95_MAIN07_DEVICE", "", "", 1);
