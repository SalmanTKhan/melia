...
public class FPilgrimroad415NpcScript : GeneralScript
{
	public override void Load()
	{
		...
		// Monk Stella
		//-------------------------------------------------------------------------
		AddNpc(9, 155126, "Monk Stella", "f_pilgrimroad_41_5", -1518.024, -51.90837, 681.9841, 9, "PILGRIM415_SQ_01", "", "", 1);
		
		// Monk Stella
		//-------------------------------------------------------------------------
		AddNpc(10, 155126, "Monk Stella", "f_pilgrimroad_41_5", -126.7505, -60.48248, -923.7063, 90, "PILGRIM415_SQ_09", "", "", 1);
		
		// Monk Stella
		//-------------------------------------------------------------------------
		AddNpc(11, 155126, "Monk Stella", "f_pilgrimroad_41_5", -779.813, -98.99318, 275.5391, 123, "PILGRIM415_SQ_10", "", "", 1);
		
		// Monk Mattas
		//-------------------------------------------------------------------------
		AddNpc(12, 155046, "Monk Mattas", "f_pilgrimroad_41_5", 1059.891, -11.48038, 250.2739, 19, "PILGRIM415_SQ_03", "", "", 1);
		
		// Monk Mattas
		//-------------------------------------------------------------------------
		AddNpc(13, 155046, "Monk Mattas", "f_pilgrimroad_41_5", -742.8293, -98.99318, 360.9496, 10, "PILGRIM415_SQ_06", "PILGRIM415_SQ_06_1", "", 1);
		
		// Monk Mattas
		//-------------------------------------------------------------------------
		AddNpc(14, 155046, "Monk Mattas", "f_pilgrimroad_41_5", -742.8293, -98.99318, 360.9496, 10, "PILGRIM415_SQ_06_2", "", "", 1);
		
		// High Officer Medea
		//-------------------------------------------------------------------------
		AddNpc(15, 156006, "High Officer Medea", "f_pilgrimroad_41_5", 1170.19, 37.8351, -861.1136, 21, "PILGRIM415_SQ_08", "", "", 1);
		
		// High Officer Medea
		//-------------------------------------------------------------------------
		AddNpc(16, 156006, "High Officer Medea", "f_pilgrimroad_41_5", -773.5663, -98.99318, 323.9143, 90, "PILGRIM415_SQ_08_1", "", "", 1);
		
		// UnVisibleName
		//-------------------------------------------------------------------------
		AddNpc(17, 47107, "UnVisibleName", "f_pilgrimroad_41_5", -1204.466, -65.60629, -1109.019, 90, "PILGRIM415_SQ_02", "PILGRIM415_SQ_02_1", "", 0);
		
		// UnVisibleName
		//-------------------------------------------------------------------------
		AddNpc(18, 47107, "UnVisibleName", "f_pilgrimroad_41_5", 1414.809, -11.48039, 36.67443, 90, "PILGRIM415_SQ_05", "", "", 0);
		
		// UnVisibleName
		//-------------------------------------------------------------------------
		AddNpc(19, 47107, "UnVisibleName", "f_pilgrimroad_41_5", 1395.321, 37.83511, -1146.479, 90, "PILGRIM415_SQ_07", "", "", 0);
		
		// UnVisibleName
		//-------------------------------------------------------------------------
		AddNpc(20, 153149, "UnVisibleName", "f_pilgrimroad_41_5", -1204.466, -65.60629, -1109.019, 90, "PILGRIM415_SQ_10_1", "", "", 1);
		
		// UnVisibleName
		//-------------------------------------------------------------------------
		AddNpc(21, 153149, "UnVisibleName", "f_pilgrimroad_41_5", 1414.809, -11.48039, 36.67443, 90, "PILGRIM415_SQ_10_2", "", "", 1);
		
		// UnVisibleName
		//-------------------------------------------------------------------------
		AddNpc(22, 153149, "UnVisibleName", "f_pilgrimroad_41_5", 1395.321, 37.83511, -1146.479, 90, "PILGRIM415_SQ_10_3", "", "", 1);
