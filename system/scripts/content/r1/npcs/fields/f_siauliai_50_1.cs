...
public class FSiauliai501NpcScript : GeneralScript
{
	public override void Load()
	{
		...
		//  
		//-------------------------------------------------------------------------
		AddNpc(4, 47203, " ", "f_siauliai_50_1", -1143.512, 0.2093, -1374.933, 90, "SIAULIAI_50_1_SQ_GRASS", "SIAULIAI_50_1_GRASS_MESSAGE", "", 0);
		...
		// Soldier Peirce
		//-------------------------------------------------------------------------
		AddNpc(7, 20019, "Soldier Peirce", "f_siauliai_50_1", -1885.54, -209.7, 27.54, 90, "SIAULIAI_50_1_SQ_SOLDIER03", "", "", 0);
		...
		// Soldier Peirce
		//-------------------------------------------------------------------------
		AddNpc(16, 20019, "Soldier Peirce", "f_siauliai_50_1", -247.7353, 0.2093, -314.5381, 62, "SIAULIAI_50_1_SQ_SOLDIER03_AFTER", "", "", 1);
		
		// Soldier Gatus
		//-------------------------------------------------------------------------
		AddNpc(17, 20015, "Soldier Gatus", "f_siauliai_50_1", 67.28238, 0.2093, -502.2321, 190, "SIAULIAI_50_1_SQ_SOLDIER04", "", "", 1);
		
		// Soldier Turan
		//-------------------------------------------------------------------------
		AddNpc(18, 20014, "Soldier Turan", "f_siauliai_50_1", -121.6255, 0.2093, -342.6637, -2, "SIAULIAI_50_1_SQ_SOLDIER05", "", "", 1);
		
		// Soldier Ramos
		//-------------------------------------------------------------------------
		AddNpc(19, 20013, "Soldier Ramos", "f_siauliai_50_1", -247.3996, 0.2093, -383.0731, 90, "SIAULIAI_50_1_SQ_SOLDIER06", "", "", 1);
		
		// Soldier Varan
		//-------------------------------------------------------------------------
		AddNpc(20, 20011, "Soldier Varan", "f_siauliai_50_1", -241.4549, 0.2093, -455.5384, 110, "SIAULIAI_50_1_SQ_SOLDIER07", "", "", 1);
		...
		//  
		//-------------------------------------------------------------------------
		AddNpc(43, 20024, " ", "f_siauliai_50_1", 1868.28, 22.2216, 507.2224, 90, "SIAULIAI50_FENCE_BUILD01", "", "", 1);
		
		//  
		//-------------------------------------------------------------------------
		AddNpc(44, 20024, " ", "f_siauliai_50_1", 1920.902, 22.2216, 438.4957, 90, "SIAULIAI50_FENCE_BUILD03", "", "", 1);
		
		//  
		//-------------------------------------------------------------------------
		AddNpc(45, 20024, " ", "f_siauliai_50_1", 1918.11, 22.2216, 561.4652, 90, "SIAULIAI50_FENCE_BUILD02", "", "", 1);
		
		//  
		//-------------------------------------------------------------------------
		AddNpc(46, 20024, " ", "f_siauliai_50_1", 1839.613, 22.2216, 696.5456, 90, "SIAULIAI50_FENCE_BUILD05", "", "", 1);
		
		//  
		//-------------------------------------------------------------------------
		AddNpc(47, 20024, " ", "f_siauliai_50_1", 1965.257, 22.2216, 685.0032, 90, "SIAULIAI50_FENCE_BUILD07", "", "", 1);
		
		//  
		//-------------------------------------------------------------------------
		AddNpc(48, 20024, " ", "f_siauliai_50_1", 1903.923, 22.2216, 749.207, 90, "SIAULIAI50_FENCE_BUILD06", "", "", 1);
		
		//  
		//-------------------------------------------------------------------------
		AddNpc(49, 20024, " ", "f_siauliai_50_1", 1978.54, 22.2216, 517.7938, 90, "SIAULIAI50_FENCE_BUILD04", "", "", 1);
		...
		//  
		//-------------------------------------------------------------------------
		AddNpc(72, 20024, " ", "f_siauliai_50_1", 1902.218, 22.2216, 632.1721, 90, "SIAULIAI50_FENCE_BUILD08", "", "", 1);
