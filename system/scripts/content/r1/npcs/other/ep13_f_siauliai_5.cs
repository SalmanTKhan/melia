...
public class Ep13FSiauliai5NpcScript : GeneralScript
{
	public override void Load()
	{
		...
		// 
		//-------------------------------------------------------------------------
		AddNpc(7, 160047, "", "ep13_f_siauliai_5", -500.6208, 15.98207, 139.8066, 21, "EP13_F_SIAULIAI_5_RAGANA", "", "", 1);
		...
		// 
		//-------------------------------------------------------------------------
		AddNpc(9, 150210, "", "ep13_f_siauliai_5", 977.57, 15.98207, 214.0969, 9, "EP13_F_SIAULIAI_5_BAIGA", "", "", 1);
